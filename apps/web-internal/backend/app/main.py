...
from .routers import projects, scans, files, context, batches, insights, agents, users, queries, ai_processing, agent, context_tree
...
app.include_router(context_tree.router, prefix="/api/context-tree", tags=["Context Tree"])
